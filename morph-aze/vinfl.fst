...
$t_acak$ = <t_fut>:{<bY><A>c<A><Q>} <MB>  % future
...
$t_iyor$ = <t_cont>:{<bY><I>r} <MB>      % present cont.
...
$p4_1s$ = <1s>:{<bY><I>m} % Imho needs to be better categorized, it this is an imperative i'm Madonna
$p4_2s$ = <2s>:{<>} <MB>
$p4_3s$ = <3s>:{s<I>n} <MB>
$p4_1p$ = <1p>:{<bY><I><Q>} <MB>
$p4_2p$ = <2p>:{<bY><I>n} <MB>
...
% note: 2psg formal form is not in
$p_g4$ = $p4_2s$ | $p4_3s$ |  $p4_2p$ | $p4_3p$ | $p4_1s$ | $p4_1p$
...
$vn_dik$  = <vn_dik>:{d<I><Q>} <MB>                                                                                                  
$vn_acak$ = <vn_acak>:{<bY><A>c<A><Q>} <MB>                                                                                          
...
% participles 
$part_dik$  = <part_dik>:{d<I><Q>} <MB>
$part_acak$ = <part_acak>:{<bY><A>c<A><Q>} <MB>
$part_yan$  = <part_yan>:{<bY><A>n} <MB>


% the rest forms converbs
$cv_dik$  = <cv_dik>:{d<I><Q>} <MB>
$cv_acak$ = <cv_acak>:{<bY><A>c<A><Q>} <MB>
$cv_ma$   = <cv_ma>:{m<A>} <MB>
